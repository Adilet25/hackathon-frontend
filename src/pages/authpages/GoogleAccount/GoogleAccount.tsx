    ...
    <div>
      ...
      <div className={classes.titleDiv}>
        ...
        <p className={classes.p}>
          Сайт "Oimok" будет предоставлен доступ к вашим данным: имени, адресу
          электронной почты, языковым настройкам и фото профиля. Прежде чем
          начать работу с сайтом “Oimo", вы можете ознакомиться с его политикой
